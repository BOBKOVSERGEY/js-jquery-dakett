/* Этот сценарий находится внутри функции-выражения, вызываемой сразу после создания. Это делается для защиты области видимости переменных */
